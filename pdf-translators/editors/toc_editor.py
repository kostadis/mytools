...
Usage:
    python3 editors/toc_editor.py                      # http://localhost:5101
    python3 editors/toc_editor.py adventure-foo.json   # pre-load a specific file
    PORT=5200 python3 editors/toc_editor.py
"""
