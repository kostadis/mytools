...
Usage:
    python3 editors/probe_editor.py                       # default http://127.0.0.1:5107
    python3 editors/probe_editor.py --port 5107
    python3 editors/probe_editor.py --host 127.0.0.1 --port 5107 --file ~/markdown.md
    python3 editors/probe_editor.py --url http://127.0.0.1:5107 --repeat 3
