...
Usage:
    python3 extract_images.py input.pdf [--out DIR] [--pages RANGE] [--min-bytes N]

Examples:
    python3 extract_images.py module.pdf
    python3 extract_images.py module.pdf --out maps/ --pages 10-25
    python3 extract_images.py module.pdf --min-bytes 8192   # skip icons/decorations
"""
