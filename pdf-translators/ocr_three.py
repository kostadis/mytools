...
Usage::
    ...
    python3 ocr_three.py                 # the three hardcoded failures
    python3 ocr_three.py a.pdf b.pdf     # or any explicit PDFs you pass

Then encode them into 5etools JSON:

    python3 batch_convert.py --plan reuse --phase encode
"""
...
def main(argv=None) -> int:
    ...
    print(f"           resume: python3 batch_mistral_ocr.py "
    ...
    print("Next: python3 batch_convert.py --plan reuse --phase encode")
