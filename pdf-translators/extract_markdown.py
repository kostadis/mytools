...
feeding it to the converter:
    ...
    python3 extract_markdown.py input.pdf                 # Marker (local GPU)
    python3 extract_markdown.py input.pdf --provider mistral
    # edit input.md as needed
    python3 pdf_to_5etools_v2.py input.pdf --from-markdown input.md
...
def main(argv=None) -> int:
    ...
    if args.provider == "mistral":
        ...
        from pdf_to_5etools_v2 import run_marker
    ...
    print(f"  python3 pdf_to_5etools_v2.py {pdf_path.name} "
