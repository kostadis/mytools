---
name: voice-smooth
description: Perform voice-smooth specialist work, resuming CampaignGenerator session review when a session_workflow.yaml is present.
---
