...
description: Perform session-summary-consistency specialist work, resuming CampaignGenerator session review when a session_workflow.yaml is present.
---
