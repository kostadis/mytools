...
tools: Read, Bash, Edit, Artifact, AskUserQuestion, WebFetch
---
...
In artifact mode (step 0), the rulings move to the page instead of this report's apply prompt — see **Artifact mode** below.
