---
name: voice-critic
description: Perform voice-critic specialist work, resuming CampaignGenerator session review when a session_workflow.yaml is present.
---
