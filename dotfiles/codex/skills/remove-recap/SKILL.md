---
name: remove-recap
description: Perform remove-recap specialist work, resuming CampaignGenerator session review when a session_workflow.yaml is present.
---
