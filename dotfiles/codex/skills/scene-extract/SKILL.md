---
name: scene-extract
description: Perform scene-extract specialist work, resuming CampaignGenerator session review when a session_workflow.yaml is present.
---
