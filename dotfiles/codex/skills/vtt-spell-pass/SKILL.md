---
name: vtt-spell-pass
description: Perform vtt-spell-pass specialist work, resuming CampaignGenerator session review when a session_workflow.yaml is present.
---
