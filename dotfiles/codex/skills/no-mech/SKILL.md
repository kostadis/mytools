---
name: no-mech
description: Perform no-mech specialist work, resuming CampaignGenerator session review when a session_workflow.yaml is present.
---
